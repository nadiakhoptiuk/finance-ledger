...
var _changeHeaderBg = require("./js/changeHeaderBg");
...
parcelHelpers.export(exports, "headerSectionRef", ()=>headerSectionRef);
parcelHelpers.export(exports, "navRef", ()=>navRef);
parcelHelpers.export(exports, "formRef", ()=>formRef);
parcelHelpers.export(exports, "requiredFormInputRef", ()=>requiredFormInputRef);
const headerSectionRef = document.querySelector("#js-header");
const navRef = document.querySelector(".main-nav");
...
},{}],"zFiGh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "changeHeaderBg", ()=>changeHeaderBg);
var _refs = require("./refs");
function changeHeaderBg() {
    let device = window.innerWidth < 768 ? "mobile" : "desktop";
    if (device === "mobile") window.scrollY > 120 ? (0, _refs.headerSectionRef).classList.add("visible") : (0, _refs.headerSectionRef).classList.remove("visible");
    if (device === "desktop") window.scrollY > 70 ? (0, _refs.headerSectionRef).classList.add("visible") : (0, _refs.headerSectionRef).classList.remove("visible");
}

},{"./refs":"2WoF2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ax0jI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "scrollToAnchor", ()=>scrollToAnchor);
var _setActiveLink = require("./setActiveLink");
function scrollToAnchor(evt) {
    if (evt?.target?.nodeName !== "A") return;
    const anchorId = evt?.target?.attributes?.href?.value;
    if (anchorId === "/index.html") return;
    else {
        evt.preventDefault();
        const neededSection = document.querySelector(`${anchorId}`);
        neededSection?.scrollIntoView({
            block: "nearest",
            behavior: "smooth"
        });
        (0, _setActiveLink.updateLink)(anchorId);
    }
}

},{"./setActiveLink":"fBJAo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fBJAo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateLink", ()=>updateLink);
function updateLink(id) {
    document.querySelector(".nav__link--current")?.classList.remove("nav__link--current");
    document.querySelector(`a[href="${id}"]`)?.classList.add("nav__link--current");
}
...
var _refs = require("./refs");
(0, _notiflixDefault.default).Report.init({
    success: {
        background: "#32c682",
        textColor: "#28a745",
...
function onFormSubmit(event) {
    ...
    if (userEmail.trim() === "" || !userEmail.includes("@") || !userEmail.includes(".")) {
        ...
        (0, _notiflixDefault.default).Report.success("", "Thanks for your request. Our manager will contact you", "Back to site", function callback() {
            window.location.href = "index.html";
        });
    }
}

},{"./refs":"2WoF2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix/build/notiflix-notify-aio":"eXQLZ","notiflix":"5WWYd"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequire4abd")
